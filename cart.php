...
<div class="cart content-wrapper">
    ...
    <form action="index.php?page=cart" method="post">
        <table class ="col-md-12" >
            ...
            <tbody>
                ...
                <tr>
                    <td class="img">
                        <a href="index.php?page=product&id=<?=$product['id']?>">
                            <img src="img/<?=$product['Main_Image']?>" width="50" height="50" alt="<?=$product['Product_Name']?>">
                        </a>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                  <td> <span class="text"><strong>Subtotal</strong></span>  </td>
                  <td><span class="price"><strong>&dollar;<?=$subtotal?></strong></span></td>  
                </tr>                 
        ...
        <button class="primary-btn"  value="Update" type="submit" name="update" >                
                Update
            </button>
                    
                    <a class="primary-btn cta-btn" href="index.php?page=checkout">            
                <i class="fa fa-arrow-circle-right"></i></i>
                Check Out
